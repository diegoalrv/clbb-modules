...
class Indicator():
    ...
    def load_env_variables(self):
        ...
        self.mapping = {
            'ZONA ├â┬üREA VERDE': 'Espacios naturales y Areas verdes',
            'ZONA EQUIPAMIENTO': 'Equipamientos y servicios',
            'ZONA RESIDENCIAL': 'Habitacional',
            'ZONA NO EDIFICABLE': 'Otros',
            'ZONA EXTENSI├âÔÇ£N RESIDENCIAL': 'Habitacional',
            'ZONA INDUSTRIAL': 'Industrial',
            'ZONA EXTENSI├âÔÇ£N EQUIPAMIENTO': 'Equipamientos y servicios',
            'ZONA PROTECCI├âÔÇ£N DE CERRO': 'Espacios naturales y Areas verdes',
            'ZONA SERVICIOS COMERCIALES': 'Comercio',
            'ZONA ESPARCIMIENTO': 'Deporte y recreaci├│n',
            'ZONA PROTECCI├âÔÇ£N BORDE COSTERO DE RECREACI├âÔÇ£N': 'Deporte y recreaci├│n',
            'ZONA PROTECCI├âÔÇ£N DE DRENAJE': 'Espacios naturales y Areas verdes',
            'ZONA PROTECCI├âÔÇ£N DE BORDE COSTERO': 'Espacios naturales y Areas verdes',
            'ZONA CALETA': 'Otros',
            'ZONA EXTENSI├âÔÇ£N INDUSTRIAL': 'Industrial',
            'ZONA PUERTO PESQUERO': 'Industrial',
            'ZONA PUERTO COMERCIAL': 'Industrial',
            'ZONA INTER├âÔÇ░S INSTITUCIONAL': 'Bienes comunes',
            'ZONA INFRAESTRUCTURA': 'Bienes comunes',
            'ZONA EXTENSI├âÔÇ£N SERVICIOS COMERCIALES': 'Comercio',
            'ZONA EXTENSI├âÔÇ£N PUERTO COMERCIAL': 'Industrial',
            'ZONA EXTENSI├âÔÇ£N ESPARCIMIENTO': 'Deporte y recreaci├│n',
            'ZONA CEMENTERIO': 'Otros',
            'ZONA ANTEPUERTO': 'Industrial',
            'ZONA EXTENSI├âÔÇ£N ANTEPUERTO': 'Industrial',
            'ZONA PROTECCI├âÔÇ£N DE DUNA': 'Espacios naturales y Areas verdes',
            'ZONA PROTECCI├âÔÇ£N DE MARISMA': 'Espacios naturales y Areas verdes',
            'ZONA RESIDENCIAL EQUIPAMIENTO': 'Habitacional',
            'ZONA EXTENSI├âÔÇ£N ├â┬üREA VERDE': 'Espacios naturales y Areas verdes',
            'ZONA PROTECCI├âÔÇ£N DE BORDE DE LAGUNA': 'Espacios naturales y Areas verdes',
            'ZONA AEROPUERTO': 'Equipamientos y servicios',
            'AGUA': 'Espacios naturales y Areas verdes',
            'Industria y Transporte': 'Industrial',
            'Comercio': 'Comercial',
            'Oficina': 'Comercial',
            'Hotel': 'Comercial',
            'Bienes Comunes': 'Equipamientos y servicios',
            'Educaci├│n y Cultura': 'Equipamientos y servicios',
            'Ecosistemas Naturales': 'Espacios naturales y Areas verdes',
            'Parques Naturales': 'Espacios naturales y Areas verdes',
            '├üreas Verdes': 'Espacios naturales y Areas verdes',
            'Deporte y recreaci├│n': 'Deporte y recreaci├│n',
            'Administraci├│n P├║blica y Defensa': 'Bienes comunes',
            'Bodega y Almacenaje': 'Equipamientos y servicios',
            'Ecosistemas Acu├íticos': 'Espacios naturales y Areas verdes',
    ...
    def load_h3_cells(self):
        ...
        if os.path.exists(input_path):
            ...
            # Crear una nueva columna en el DataFrame con la geometr├¡a de cada hex├ígono
    ...
    # Funci├│n para convertir c├│digo H3 a un pol├¡gono de Shapely
    ...
    def compute_percentage(self):
        ...
        gdf_area_by_use = gdf_overlay.groupby(['new_use']).agg({'area_interseccion': 'sum'}).reset_index().rename(columns={'area_interseccion': 'area_by_use'})
