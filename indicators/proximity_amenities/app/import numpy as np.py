...
class Indicator():
    ...
    def compute_percentage(self):
        ...
        gdf_overlay['simple_use'] = gdf_overlay['use'].apply(simplify_string)
        gdf_overlay = pd.merge(gdf_overlay, mapping_df, how='left', left_on='simple_use', right_index=True)
        del gdf_overlay['simple_use']
